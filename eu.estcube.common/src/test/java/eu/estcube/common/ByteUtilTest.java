...
public class ByteUtilTest {
    ...
    public void testToHexStringEmptyArray() {
        ...
        assertEquals("", ByteUtil.toHexString(noBytes));
        assertEquals("", ByteUtil.toHexString(noBytes, -1));
        assertEquals("", ByteUtil.toHexString(noBytes, 0));
        assertEquals("", ByteUtil.toHexString(noBytes, 1));
        assertEquals("", ByteUtil.toHexString(noBytes, 10));
        assertEquals("", ByteUtil.toHexString(noBytes, 100));
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testToBytesfromHexStringNull() {
        ByteUtil.toBytesFromHexString(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testToBytesfromHexStringBlankValue() {
        ByteUtil.toBytesFromHexString("");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testToBytesfromHexStringEmptyValue() {
        ByteUtil.toBytesFromHexString(" ");
    }
