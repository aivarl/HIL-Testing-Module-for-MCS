...
public class Constants {
    ...
    public static final String AMQ_GS_COMMANDS = "gsCommands";
    public static final String AMQ_GS_COMMANDS_RADIO = "activemq:queue:gsCommands?selector="
            + Constants.HEADER_COMPONENT_ID + "%3D'" + Constants.CMDG_HEADER_RADIO + "'";
    public static final String AMQ_GS_COMMANDS_ROTATOR = "activemq:queue:gsCommands?selector="
            + Constants.HEADER_COMPONENT_ID + "%3D'" + Constants.CMDG_HEADER_ROTATOR + "'";
    ...
    public static final String AMQ_RETRIEVE = "activemq:queue:customQueryRetreive";
    ...
    public static final int DATABASE_BEACON_ISSUEDBY_LENGTH = 50;
}