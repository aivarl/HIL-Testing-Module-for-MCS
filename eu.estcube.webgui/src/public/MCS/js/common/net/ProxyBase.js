define([
    ...
    function(declare, Topic, Constants) {
        ...
        return declare("ProxyBase", null, {
            ...
            constructor: function(args) {
                ...
                this.activeChannels = [];
                Topic.subscribe(Constants.TOPIC_CHANNEL_REQUEST, dojo.hitch(this, this.subscribeToChannel));
                Topic.subscribe(Constants.TOPIC_CHANNEL_SEND_MESSAGE, dojo.hitch(this, this.sendMessage));
            },
            ...
            parseInvalidInput: function(input) {
                if(input == null || typeof(input) == "undefined") {
                    console.error("[ProxyBase] parseInvalidInput: input is null/undefined");
                    return;
                }
